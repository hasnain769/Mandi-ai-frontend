      ...
      <div className="relative bg-white/95 backdrop-blur-xl p-8 rounded-3xl shadow-2xl w-full max-w-sm border border-white/20">
        ...
        <div className="flex flex-col items-center mb-8">
          <div className="bg-white p-2 rounded-xl mb-3 shadow-sm border border-gray-100">
            <img src="/mandibook-logo.png" alt="Mandibook" className="h-16 w-auto object-contain" />
          </div>
          <h1 className="text-3xl font-bold text-gray-900 tracking-tight">Mandibook</h1>
